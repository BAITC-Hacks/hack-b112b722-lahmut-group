...
Статус: предлагаемый план, реализация ещё не начата. План рассчитан на 3 разработчиков. Конкретный профиль моделей выбирается после проверки доступного железа; время обработки пока не измерено.
